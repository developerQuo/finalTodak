...
<%
	...
	if(curGroup > 0) {
%>
	<a href="<%=url%>?<%=str%>curPage=1&message=''&selectFunc=''">◁◁</a>&nbsp;&nbsp;&nbsp;
	<a href="<%=url%>?<%=str%>curPage=<%=linkPage%>&message=''&selectFunc=''">◀</a>&nbsp;&nbsp;&nbsp;
<%
	}else{
%>
		◁◁&nbsp;&nbsp;&nbsp;◀&nbsp;&nbsp;&nbsp;
...
%>
			&nbsp;[<a href="<%=url%>?<%=str%>curPage=<%=linkPage%>&message=''&selectFunc=''"><%=linkPage%></a>]
<%
		}
...
%>
		<a href="<%=url%>?<%=str%>curPage=<%=linkPage%>&message=''&selectFunc=''">▶</a>&nbsp;&nbsp;&nbsp;
		<a href="<%=url%>?<%=str%>curPage=<%=pageCount%>&message=''&selectFunc=''">▷▷</a>&nbsp;&nbsp;&nbsp;
<%
	}else{
%>
		&nbsp;&nbsp;&nbsp;▶&nbsp;&nbsp;&nbsp;▷▷
