			...
			$(document).ready(function() {
				...
				$('#members').change(function() {
					...
					if(($('#firstApplicant').html()=='') && ($('#secondApplicant').html()=='') && ($('#thirdApplicant').html()=='')) {
						...
						if((member_name.indexOf('팀장') != -1) && (deptnum == '0107')) {
							console.log("if((member_name.indexOf('팀장') != -1) && (deptnum == '0107')) 진입 >>> ");
							...
							console.log("if((member_name.indexOf('팀장') != -1) && (head == '01'))-else 진입 >>> ");
						
							alert("1차 결재자는 기획 팀장이어야 합니다.");
						...
						if((member_name.indexOf('본부장') != -1) && (head == '01')) {
							console.log("if((member_name.indexOf('본부장') != -1) && (head == '01')) 진입 >>> ");
							...
							console.log("if((member_name.indexOf('본부장') != -1) && (head == '01'))-else 진입 >>> ");
						
							alert("2차 결재자는 전략기획 본부장이어야 합니다.");
