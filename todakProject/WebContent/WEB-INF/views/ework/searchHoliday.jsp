...
<html>
	<head>
		...
		$(document).ready(function() {
			...
			function sort(eh_sort) {
				var sort = "";
				
				if(eh_sort == '47') sort = "연차";
				if(eh_sort == '48') sort = "월차";
				if(eh_sort == '49') sort = "반차";
				if(eh_sort == '50') sort = "병가";
				if(eh_sort == '51') sort = "정기휴가";
	...
	%>
		...
		<div class="context-container">
			...
			<table align="center">
				...
				<tr>
					<td>
						<table id="signstamp" border="1" align="right">
							<colgroup>
								<col width="90px"/>
								<col width="90px"/>
								<col width="90px"/>
			...
			<form id="search_form" name="search_form" method="POST">
				<div id="detail_div">
					<table class="auth_detail" id="detail_holiday" cellpadding="10">
						<colgroup>
							<col width="200px"/>
							<col width="300px"/>
						</colgroup>
						...
						<tr>
							...
							<td width="600">
								<%=hvo.getEa_num() %>
								<input type="hidden" id="ea_num" name="ea_num" value="<%=hvo.getEa_num()%>">
							</td>
						</tr>
						<tr>
							<td>제목</td>
						...
						<tr>
							...
							<td>
								<script type="text/javascript">
										document.write(position(<%=hvo.getHm_position()%>));
								</script>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<script type="text/javascript">
									document.write(sort(<%=hvo.getEh_sort()%>));
								</script>
							</td>
						</tr>
						<tr>
							...
							<td>
								...
								<%=startdate_year%>.<%=startdate_month%>.<%=startdate_day%> ~
								<%=endperiod_year%>.<%=endperiod_month%>.<%=endperiod_day%>
							</td>
						</tr>
						<tr>
							<td>분류</td>
							<td>
								<script type="text/javascript">
									document.write(group(<%=hvo.getEh_group()%>));
								</script>
							</td>
						</tr>
						<tr>
							<td>휴가 사유</td>
							<td>
								<div name="eh_reason" id="eh_reason"
